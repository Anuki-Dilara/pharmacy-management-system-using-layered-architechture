...
public class EmployeeViewFormController implements Initializable {
    ...
    void btnAddEmployeeOnAction(ActionEvent event) {
        ...
        try {
            boolean isSaved = employeeBO.addEmployee(new EmployeeDTO(employee_id, employee_name,employee_address,employee_contactNumber,employee_salary,employee_age));
            if (isSaved) {
    ...
    void btnSearchEmployeeOnAction(ActionEvent event) {
        String employee_id = txtEmployeeId.getText();
        try {
            EmployeeDTO employee = employeeBO.searchEmployee(employee_id);
            if (employee != null) {
    ...
    void btnUpdateEmployeeOnAction(ActionEvent event) {
        ...
        try {
            boolean   isUpdated = employeeBO.updateEmployee(new EmployeeDTO(employee_id, employee_name, employee_address, employee_contactNumber,employee_salary,employee_age));
            if (isUpdated) {
